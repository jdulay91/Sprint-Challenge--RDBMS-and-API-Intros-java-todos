...
public interface UserRepository extends CrudRepository<User, Long>
{
     ...
     */
    @Query(value = "SELECT u.username as usernamerpt, count(t.todoid) as " +
            "counttodos FROM users u JOIN todos t ON u.userid = t.userid " +
            "WHERE NOT t.completed GROUP BY u.username ORDER BY usernamerpt",
            nativeQuery = true)
